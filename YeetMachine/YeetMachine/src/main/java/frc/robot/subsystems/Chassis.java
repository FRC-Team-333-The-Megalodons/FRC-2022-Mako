...
public class Chassis extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if((Constants.xboxDrive && controller.getYButton()) || joystick.getRawButton(Constants.JoyStickButtons.LOW_GEAR)){//joystick.getRawButton(Constants.JoyStickButtons.LOW_GEAR)
      low();
      //System.out.println("low");
    }

    if((Constants.xboxDrive && controller.getXButton()) || joystick.getRawButton(Constants.JoyStickButtons.HIGH_GEAR)){//joystick.getRawButton(Constants.JoyStickButtons.HIGH_GEAR)
      high();
