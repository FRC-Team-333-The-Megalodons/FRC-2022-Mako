...
public class Intake extends SubsystemBase {
  ...
  private final double INTAKE_SPEED = 0.95
  ;
  ...
  public Intake() {
    ...
    intakeSolenoid = hub.makeSolenoid(Constants.DeviceIDs.INTAKE_SOLENOID);
  }
  ...
  public void periodic() {
    ...
    if((Constants.xboxDrive && controller.getRightBumper()) || joystick.getRawButton(Constants.JoyStickButtons.INTAKE_RUN)){//joystick.getRawButton(Constants.JoyStickButtons.INTAKE_RUN
      runIntake();
      controller.setRumble(RumbleType.kLeftRumble, 0.5);
      //System.out.println("intaking balls");
    }else if((Constants.xboxDrive && controller.getLeftTriggerAxis() > 0) || joystick.getRawButton(Constants.JoyStickButtons.INTAKE_REVERSE)){//joystick.getRawButton(Constants.JoyStickButtons.INTAKE_REVERSE
      runIntakeReverse();
    ...
    */
    ...
    if ((Constants.xboxDrive && controller.getAButton()) || joystick.getRawButton(Constants.JoyStickButtons.INTAKE_FORWARD)) {
      intakeOut();
